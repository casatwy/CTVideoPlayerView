#
#  Be sure to run `pod spec lint CTVideoView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    1. can play multi-video at the same time
  ...
  s.source       = { :git => "https://github.com/casatwy/CTVideoView.git", :tag => s.verision.to_s }
  ...
  s.source_files  = "CTVideoView/CTVideoView/**/*.{h,m}"
  ...
  s.frameworks = "UIKit", "AVFoundation", "CoreMedia", "Foundation"
